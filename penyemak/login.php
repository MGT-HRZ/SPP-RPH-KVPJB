...
<body onload="realtimeClockDateDay()" class="image-bckgrd">
    ...
    <center><p id="login-title" class="text-white fw-semibold">SPP-RPH REVIEWER</p></center>
    ...
    <?php 
        include_once 'php/footer-log.php';
        include_once 'php/ad-login.php'; 
    ?>
