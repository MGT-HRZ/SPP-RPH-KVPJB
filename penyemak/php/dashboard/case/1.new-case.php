...
<!-- New Case -->
<div class="card shadow mb-4 border-danger" id="modal-form">
    <div class="card-header bg-danger border-danger py-3" id="modal-form">
        <h6 class="m-0 mt-2 mb-3 font-weight-bold text-center">
            <span class="text-danger bg-white rounded-circle" style="font-size: medium; padding: 6px 13px 6px 13px;">1</span>
        </h6>
    ...
    <div class="card-body">
        <?php 
            ...
            while ($row_new_case = mysqli_fetch_assoc($result_new_case)) {
                ...
                if ($post == 1) {
                    NewCase($id_case, $name, $cate, $case_date, $descpt);
                }
            }
         ?>
    </div>
