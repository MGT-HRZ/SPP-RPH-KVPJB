...
<!-- New Case -->
<div class="card shadow mb-4 border-warning" id="modal-form">
    <div class="card-header bg-warning border-warning py-3" id="modal-form">
        <h6 class="m-0 mt-2 mb-3 font-weight-bold text-center">
            <span class="text-warning bg-white rounded-circle" style="font-size: medium; padding: 6px 12px 6px 12px;">2</span>
        </h6>
    ...
    <div class="card-body">
        <?php 
            ...
            while ($row_new_case = mysqli_fetch_assoc($result_new_case)) {
                ...
                if ($post == 2) {
                    OngoingCase($id_case, $name, $cate, $case_date, $descpt);
                }
            }
         ?>
    </div>
