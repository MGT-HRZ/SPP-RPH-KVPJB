<?php
    ...
    $filter1 = $_POST['input_filter1_overall'];
    //$id_pensyarah = $_POST['input_id_pensyarah_overall'];
    $filter_dropdown1 = $_POST['dropdown_filter1_overall'];
    $filter_date = $_POST['date_filter_overall'];
    $filter_status = $_POST['status_filter_overall'];
    $filter_year = $_POST['year_filter_overall'];
    $id_roles = $_POST['input_roles_overall'];
    ...
    if ($id_roles == 1) {
        ...
        $sql_filter = "SELECT pensyarah.nama_pensyarah, rph.id_rph, rph.link_rph, 
            ...
            WHERE pensyarah.nama_pensyarah LIKE ?
            AND rph.minggu LIKE ?
            AND rph.status LIKE ?
    ...
    mysqli_stmt_bind_param($stmt, "sssss", $filter1, $filter_dropdown1, $filter_status, $filter_date, $filter_year);
