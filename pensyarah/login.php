<?php
    ...
    require_once 'php/date/date.php';
...
<body onload="realtimeClockDateDay()" class="image-bckgrd">
    ...
    <div class="date-time-day_slot">
        <nav class="navbar navbar-expand-md">
            <ul class="navbar-nav ms-auto space">
                <li class="nav-item">
                    <span id="date-time-day"><a id="day" class="nav-link text-white"></a></span>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse" id="btn ">
                <ul class="navbar-nav ms-auto space">
                    <li class="nav-item">
                        <span id="date-time-day"><a id="clockdate" class="nav-link text-white"></a></span>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="date-time-day_slot-mobile">
        <center>
            <nav class="p-3">
                <span id="date-time-day"><a id="day-mobile" class="nav-link text-white"></a></span>
                <span id="date-time-day"><a id="clockdate-mobile" class="nav-link text-white"></a></span>
            </nav>
        </center>
    </div>
    <!-- Mobile Date, Time, Day section -->
    ...
    <center>
        <p id="login-title" class="text-white fw-semibold">SPP-RPH LECTURER</p>
    </center>
    ...
    ?>
        ...
        <div>
            <?php include_once 'php/login/weekend_timeday-warning.php'; ?>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="card mb-4" id="login_card">
                        <div class="card-header text-center" id="login_card_head">
                        ...
                        <div class="card-body">
                            <form action="php/log.php" method="post" class="needs-validation" novalidate>
                                ...
                                <div class="form-group form-floating mb-3">
                                    <input type="number" name="user" class="form-control rounded-pill" id="floatingInput validationCustomUsername" placeholder="Username" required>
                                    <label for="floatingInput validationCustomUsername">No. IC</label>
                                    <div class="valid-feedback">Looks Good !</div>
                                    <div class="invalid-feedback">Please insert your no. ic !</div>
                                </div>
    ...
    <?php
        ...
        elseif (in_array($currentDay, $onlineDays) && ($currentTime < $onlineStartTime)) {
            include_once "php/login/daily_timeday-warning.php";
        }
        
        else {
            include_once "php/login/weekend_timeday-warning.php";
        }
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-auto">
                        ...
                        <div class="form-outline form-white mb-4">
                            <a class="btn btn-success mb-4 rounded-pill" href="#" onclick='feedback(<?php echo $num_of_dir; ?>, "<?php echo $page_dir; ?>")'>CLICK !</a>
                        </div>
                    </div>
                    <!--Grid column-->
    ...
    <?php include_once 'php/footer-log.php'; ?>
    ...
    <script src="js/to_route-menu.js"></script>
    ...
    <script src="js/clock-date-day.js"></script>
