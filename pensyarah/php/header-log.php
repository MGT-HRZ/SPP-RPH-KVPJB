...
<body>
    ...
    <div class="container-fluid">
        ...
        <!-- <div id="logo-align">
            ...
            <div id="show3">
                <img src="<?php //nav_logo_main(2, "Home", "kvperd"); ?>" alt="Logo"  class="d-inline-block align-text-top" id="kvperd-log">
            </div>
        ...
        <div id="logo-align">
            ...
            <div id="show2">
                <img src="https://meimluonline.github.io/images.meimlu.github.io/kv-logo/logo-kvpjb-2021%20glow.png" alt="Logo" class="d-inline-block align-text-top" onclick="logo_main(<?php echo $num_of_dir; ?>)" id="kvperd-log">
            </div>
        </div>
