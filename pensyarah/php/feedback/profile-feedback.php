<?php 
    ...
    require_once 'update-feedback.php';
...
<head>
    ...
    <title><?= $row['nama'] ?>'s Feedback Profile | JTM | KVPJB</title>
</head>
<body>
        ...
        <div class="col-md-8">
            <div class="card" id="update-form">
                ...
                <div class="form-group mb-3">
                        ...
                        <input type="text" id="textInput" name="idpelanggan" class="form-control" value="<?= $row['id_pelanggan']; ?>">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea rows="10" id="textInput" name="feedback" class="form-control"><?= $row['aduan']; ?></textarea>
                    </div>
