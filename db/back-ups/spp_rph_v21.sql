...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2023 at 06:21 AM
...
--
ALTER TABLE `pensyarah`
  MODIFY `id_pensyarah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `penyemak`
--
ALTER TABLE `penyemak`
  MODIFY `id_penyemak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
