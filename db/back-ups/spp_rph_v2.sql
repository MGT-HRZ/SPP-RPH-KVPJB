...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2023 at 01:45 PM
...
CREATE TABLE `admin` (
  ...
  `pass_encrpyt` varchar(255) NOT NULL
...
CREATE TABLE `jabatan` (
  ...
  `ketua_jabatan` varchar(50) NOT NULL COMMENT 'id pensyarah'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pensyarah` (`id_pensyarah`, `nama_pensyarah`, `username`, `password`, `pass_encrpyt`, `kod_program`, `email`, `no_tel`, `id_roles`) VALUES
(1, 'HASFARINA BINTI ABAS', '760830016434', '', '', '', 'hasfarina@moe.edu.my ', '', 0),
(2, 'ZARIMAH BT DARMO', '680201015658', '', '', '', 'g-58015145@moe-dl.edu.my ', '', 0),
...
(59, 'ZULFAH HANIS BINTI MD SADAKAH', '920623015762', '', '', '', '', '', 0),
...
--
ALTER TABLE `pensyarah`
  MODIFY `id_pensyarah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `penyemak`
--
ALTER TABLE `penyemak`
  MODIFY `id_penyemak` int(11) NOT NULL AUTO_INCREMENT;
