...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2023 at 03:51 PM
...
(62, 'Ts. MOHAMAD NOOR FAHMI RUZAINI BIN MD YUSOFF', '910329086093', '', '', '', '', '', 'g-93248405@moe-dl.edu.my ', '', 0),
...
(70, 'Ts. SURIYAH BINTI HASSAN', '810218015358', '', '', '', '', '', 'g-58015134@moe-dl.edu.my  ', '', 0),
...
--
ALTER TABLE `rph`
  MODIFY `id_rph` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
